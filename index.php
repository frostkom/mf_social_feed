...
if(!function_exists('is_plugin_active') || function_exists('is_plugin_active') && is_plugin_active("mf_base/index.php"))
{
	...
	if(is_admin())
	{
		...
		add_filter('pre_update_option', array($obj_social_feed, 'pre_update_option'), 10, 3);
		...
		add_filter('post_row_actions', array($obj_social_feed, 'post_row_actions'), 10, 2);
	...
	function uninstall_social_feed()
	{
		...
		mf_uninstall_plugin(array(
			...
			'user_meta' => array('meta_social_feed_callback_url', 'meta_social_feed_access_token'),
